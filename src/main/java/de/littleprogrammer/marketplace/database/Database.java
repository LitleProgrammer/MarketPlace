...
public class Database {
    ...
    public void addItem(ItemStack item, int price, Player seller) throws Exception {
        try {
            ...
            e.printStackTrace();
            throw new Exception("Error during addItem");
        }
    }

    public Document getItem(UUID uuid) throws Exception {
        try {
            RedisManager redisManager = RedisManager.getInstance();
            ...
            e.printStackTrace();
            throw new Exception("Error during getItem");
        }
    }

    public List<Document> getAllItems() throws Exception {
        try {
            ...
            e.printStackTrace();
            throw new Exception("Error during getAllItems");
        }
    }

    public void removeItem(UUID uuid) throws Exception {
        try {
            ...
            e.printStackTrace();
            throw new Exception("Error during removeItem");
        }
    }
    ...
    public void addTransaction(DatabaseTransaction transaction) throws Exception {
        ...
        try {
            ...
            updatePlayerHistory(transaction.getBuyer(), transactionID);
            updatePlayerHistory(transaction.getSeller(), transactionID);
    ...
    public DatabaseTransaction getTransaction(UUID transactionID) throws Exception {
        try {
            RedisManager redisManager = RedisManager.getInstance();
            ...
            e.printStackTrace();
            throw new Exception("Error during getTransaction");
        }
    }

    public List<DatabaseTransaction> getPlayerTransactions(UUID playerUUID) throws Exception {
        try {
            ...
            e.printStackTrace();
            throw new Exception("Error during getPlayerTransactions");
        }
    }

    public DatabasePlayer getPlayerByUUID(UUID uuid) throws Exception {
        try {
            RedisManager redisManager = RedisManager.getInstance();
            ...
            e.printStackTrace();
            throw new Exception("Error during getPlayerByUUID");
        }
    }

    public void addPlayer(DatabasePlayer databasePlayer) throws Exception {
    ...
    private void updatePlayerHistory(UUID playerUUID, UUID transactionID) throws Exception {
        DatabasePlayer databasePlayer = getPlayerByUUID(playerUUID);
        if (databasePlayer != null) {
            ...
            try {
                playersCollection.updateOne(Filters.eq("playerID", databasePlayer.getUuid().toString()), updates);
                Document playerDoc = new Document("playerID", databasePlayer.getUuid().toString())
            ...
            try {
                addPlayer(new DatabasePlayer(playerUUID, transactions));
            } catch (Exception e) {
                e.printStackTrace();
                throw new Exception("Error while updating player history");
            }
